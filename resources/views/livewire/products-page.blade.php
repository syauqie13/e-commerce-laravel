            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                            ...
                            @foreach ($categories as $category)
                                <li class="mb-4" wire:key="{{$category->id}}">
                                    <label for="" class="flex items-center dark:text-gray-400 ">
                                        <input type="checkbox" wire:model.live="selected_categories" class="w-4 h-4 mr-2" id="{{$category->slug}}"
                                            value="{{$category->id}}">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <input
                            type="range"
                            class="w-full h-2 mb-4 bg-blue-100 rounded-lg appearance-none cursor-pointer accent-blue-500"
                            value="50000000"
                            max="50000000"
                            step="1000"
                        ...
                        <!-- Min - Max Label -->
                        <div class="flex justify-between text-lg font-bold text-blue-400">
