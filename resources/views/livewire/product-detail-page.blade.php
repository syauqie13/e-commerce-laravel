                    ...
                    <div class="sticky top-0 z-50 overflow-hidden ">
                        ...
                        <div class="flex-wrap hidden md:flex ">
                            ...
                            @foreach ($product->images as $image)
                                <div class="w-1/2 p-2 aspect-square sm:w-1/4"
                                    x-on:click="mainImage='{{ url('storage', $image) }}'">
                                    <div
                                        class="overflow-hidden transition-all duration-300 border border-gray-200 shadow-sm cursor-pointer rounded-xl hover:border-blue-500">
                ...
                <div class="w-full px-4 md:w-1/2 ">
                    <div class="lg:pl-20">
                        <div class="mb-8 [&>ul]:list-disc [&>ul]:ml-4">
                            ...
                            <p class="max-w-md text-gray-700 dark:text-gray-200">
